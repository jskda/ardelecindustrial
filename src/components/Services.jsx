...
import energyStorageIcon from "../assets/energy_store.svg";

export default function Services() {
  return (
    <div className="container max-w-[1320px] mx-auto px-6 py-12 grid grid-cols-1 md:grid-cols-2 gap-8">
      ...
      <div className="flex items-start space-x-4">
        ...
        <div>
          ...
          <p className="text-gray-700">
            Rectifier systems used for production of hydrogen, metal extraction, refining and heat treatments are
            designed to operate in the most challenging operating conditions, maintaining highest efficiency.
            High-current busduct systems with high current switching devices.
          </p>
      ...
      <div className="flex items-start space-x-4">
        ...
        <div>
          <h3 className="text-gray-700 text-xl font-semibold mb-1">
            Software Development & Digital Control Systems
          </h3>
          <p className="text-gray-700">
            The digital controls systems, entirely developed by Ardelec, grant the highest level of reliability,
            safety and performance. Ardelec combines deep domain expertise with connectivity and software innovation
            to empower real-time, data-driven decisions for safer, smarter operations that maximize resource efficiency.
          </p>
      ...
      {/* Power Generation */}
      <div className="flex items-start space-x-4">
        <img src={generationIcon} alt="Power Generation Icon" className="w-12 h-12 shrink-0" />
        <div>
          <h3 className="text-gray-700 text-xl font-semibold mb-1">Power Generation</h3>
          <p className="text-gray-700">
            Ardelec offers full-cycle power generation solutions for thermal, gas-turbine, hydro, renewable and captive
            plants — engineering (studies, grid compliance, digital substations IEC 61850), supply of evacuation systems,
            diagnostics, testing, commissioning, retrofits, training and lifecycle support — all to IEC/IEEE/GOST standards.
          </p>
      ...
      {/* Engineering & Consulting (full width) */}
      <div className="md:col-span-2 flex items-start space-x-4">
        <img src={industrialIcon} alt="Industrial Icon" className="w-12 h-12 shrink-0" />

        <div>
          <h3 className="text-gray-700 text-xl font-semibold mb-3">Engineering & Consulting</h3>

          {/* Power distribution networks */}
          <h4 className="text-gray-900 font-semibold mb-2 text-lg">for Power Distribution Networks</h4>
          ...
          {/* Industrial networks */}
          <h4 className="text-gray-900 font-semibold mb-2 text-lg">for Industrial Networks</h4>
          <ul className="list-disc list-inside text-gray-700 space-y-1">
            <li>Visualization and design of optimal network topologies</li>
            <li>Diesel/gas/converter-fed generation modelling in island mode and grid-connected modes</li>
